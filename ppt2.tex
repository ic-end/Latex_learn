...
\pgfdeclareimage[mask=beidamask,totalheight=0.25cm]{beida}{beida-mark}
...
\frame
{
  ...
  \begin{itemize}
  \item 视频 \\
    \movie[externalviewer,label=mymovie,width=1in,height=0.8in,poster]{\pgfuseimage{logo}}{movie.avi}
%    \hyperlinkmovie[play]{mymovie}{Play}
  \item 声音 \\
    \movie[externalviewer,autostart]{这里有一段mp3}{turky.mp3}
  \end{itemize}
}
